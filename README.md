...
- Navegador de Compêndios integrado, com pesquisa, categorias, etiquetas e filtros por livro de origem sobre os documentos importados no mundo;
...
- Abra o **Navegador de Compêndios** pelo botão disponível no topo do diretório de **Itens**, logo abaixo de **Criar Item** e **Criar Pasta**. Ele reúne Habilidades, Poderes Místicos, Rituais, Traços, Dádivas, Fardos, Armas, Armaduras, Equipamentos, Artefatos e Monstros já importados no mundo. Cada resultado identifica seu livro de publicação original no mesmo campo da fonte; a barra lateral pode exibir somente Livro Básico, Guia Avançado, Códice de Monstros, Guia do Mestre ou outro suplemento disponível, independentemente da pasta em que o documento foi importado. Itens e Atores compartilhados apenas como **Observador** permanecem acessíveis pelo Navegador, mas são ocultados dos diretórios normais para jogadores; documentos dos quais o jogador seja Proprietário continuam visíveis normalmente. Mestres sempre enxergam os diretórios completos. Clique no bloco de um resultado para abrir sua ficha original ou arraste-o para fichas e para a hotbar. Resultados são carregados em lotes para manter a janela rápida em mundos grandes.
- A **Loja** reconhece preços exatos e intervalos como `1-4 ortegas`, `1–5 xelins` ou `1-5 táleres`. Em um intervalo, o jogador escolhe quanto deseja pagar dentro dos limites e do próprio saldo; um valor maior representa uma versão de melhor qualidade. A quantia escolhida é descontada automaticamente e passa a ser o preço registrado na cópia adicionada ao inventário, sem alterar o item-base do mundo.

- Ao abrir uma ficha de jogador totalmente nova, escolha **Usar o Criador de Fichas** ou **Preencher manualmente**. Se o jogador preferir fechar o aviso, pode marcar **Não mostrar novamente para esta ficha**; a preferência é individual e o Criador continua acessível pelo botão no topo da ficha. No modo guiado, uma introdução compacta mostra o passo atual e explica o processo. O primeiro passo lista as 15 ocupações do Livro Básico em um índice temático por arquétipo; ao clicar em uma opção, a página à direita assume a composição editorial do diário oficial, com faixa ornamentada do arquétipo, quadro de leitura arredondado, citação, descrição, Atributos importantes, Raças sugeridas, Habilidades apropriadas e a ilustração oficial da ocupação quando o módulo Symbaroum Core Rules está instalado. A escolha preenche automaticamente a ocupação da ficha e abre o segundo passo.
...
- No passo **Habilidades**, a **Compra com XP** é o fluxo único: informe o XP total e compre livremente níveis Novato (`10 XP`), Adepto (`30 XP` acumulados) ou Mestre (`60 XP` acumulados). O saldo restante ocupa o número principal do quadro e é atualizado imediatamente; abaixo ficam o XP gasto e o total informado. A lista inclui todas as Habilidades do mundo às quais o jogador possui ao menos permissão de **Observer**. O painel direito renderiza diretamente o template da ficha nativa da Habilidade fornecido pelo sistema Symbaroum, em modo de leitura e aproveitando toda a área disponível sem uma moldura externa adicional. Cabeçalho, referência, abas, descrições, ações, bônus e molduras pretas continuam vindo da ficha real, enquanto os controles de compra de XP permanecem logo abaixo dela. Bruxaria, Feitiçaria, Magismo e Teurgia recebem primeiro uma página temática que explica a tradição, seus poderes, rituais e relação com a Corrupção; a ficha nativa da Habilidade aparece ao final. Ao abrir **Poder Místico**, escolha um ou mais poderes acessíveis e o nível de cada um; clique no nome do poder para abrir sua ficha nativa e consultar todas as descrições, ações e bônus sem expandir o cartão dentro do Criador. Cada poder é comprado separadamente e o documento nativo é adicionado à ficha. Ao escolher **Ritualista**, selecione os rituais que serão aprendidos: 1 no nível Novato, 3 no Adepto ou 6 no Mestre. Traços raciais opcionais entram automaticamente no cálculo, e todos os documentos selecionados são copiados para a ficha com os níveis corretos.
...
- Na etapa **História, Personalidade e Sombra**, duas abas reúnem a biografia e a essência espiritual do personagem em um único passo. Na aba **Sombra**, navegue por páginas ilustradas de Natureza, Civilização e Escuridão, no mesmo formato de livro usado na etapa de Raças. Cada página explica o princípio espiritual, mostra uma representação visual original, apresenta exemplos clicáveis e descreve como a Corrupção pode alterar a aparência da Sombra. Tudo é confirmado junto e o texto escolhido é salvo diretamente no campo nativo de Sombra da ficha.
...
- O Criador mantém um registro persistente de todas as decisões. Antes de navegar pelas setas, ele salva um rascunho dos controles atuais, inclusive Habilidades, traços raciais, Atributos, textos e equipamentos ainda não confirmados. Ao voltar, tudo reaparece marcado; somente o botão de confirmação aplica as mudanças à ficha e conclui a etapa.
- Ao arrastar o Criador para outra região da tela, as etapas seguintes preservam a mesma posição durante toda a sessão, mesmo quando a página muda de tamanho.
- Nos passos **História e Personalidade** e **Amigos e Grupo**, o Criador grava diretamente os campos nativos da ficha e mantém o progresso salvo para retomada. Se o personagem escolheu o traço **Contatos**, a etapa de História e Personalidade recebe uma seção própria para definir a organização ou região da rede, a relação do personagem com ela, pessoas importantes, acessos e complicações; o traço não interrompe mais o fluxo depois da escolha da Raça. Todos os campos de **Amigos e Grupo** são opcionais, portanto a etapa também pode ser pulada.
...
A suíte cobre serviços do ator, permissões, contexto, hooks, Criador de Fichas, navegadores de Compêndios e Habilidades, equipamentos, armazenamento, integração com Ind Resources, rituais e atalhos da hotbar.
