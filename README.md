...
- O Criador mantém um registro persistente de todas as decisões confirmadas. As setas do marcador de etapa permitem voltar e avançar pelas partes já preenchidas sem perder as marcações: método e valores de Atributos, raça e traços, Habilidades e níveis, princípio e texto da Sombra, equipamentos, personalidade, amigos e grupo são restaurados ao reabrir cada página.
