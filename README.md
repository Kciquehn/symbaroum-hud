...
- Criador de Fichas guiado passo a passo, em um livro compacto e temático, com ocupações, Atributos e raças do Livro Básico;
...
- No passo **Atributos**, escolha no topo entre **Distribuição típica** e **Compra de pontos**. A distribuição típica reorganiza por troca automática os valores `5, 7, 9, 10, 10, 11, 13 e 15`. A compra de pontos mostra o saldo restante dos 80 pontos e permite aumentar ou reduzir cada Atributo, respeitando o intervalo de 5 a 15 e o limite de um único valor 15. As descrições explicam rapidamente o uso de Preciso, Astuto, Discreto, Persuasivo, Rápido, Resoluto, Vigoroso e Vigilante. O progresso fica salvo na própria ficha e **Continuar depois** retoma a etapa pendente na próxima abertura.
