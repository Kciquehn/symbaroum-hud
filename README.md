...
- Criador de Fichas guiado, iniciado por um livro interativo com as 15 ocupações do Livro Básico;
...
- Ao abrir uma ficha de jogador totalmente nova, escolha **Usar o Criador de Fichas** ou **Preencher manualmente**. No modo guiado, o primeiro capítulo apresenta as 15 ocupações do Livro Básico em um livro interativo; escolha uma para preencher automaticamente a ocupação da ficha. O progresso fica salvo na própria ficha e **Continuar depois** retoma o capítulo na próxima abertura.
