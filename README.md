...
- No passo **Habilidades**, pesquise as Habilidades disponíveis no mundo e clique em cada uma para ler sua descrição e os três níveis completos. Escolha entre **Cinco Novatas** ou **Duas Novatas + uma Adepta**; traços raciais opcionais descontam automaticamente uma vaga de Novato. O botão de confirmação só é liberado quando a distribuição estiver completa, e os documentos selecionados são copiados para a ficha com o nível correto e sem consumir o XP disponível do novo personagem.
