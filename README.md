...
- No passo **Habilidades**, **Compra com XP** é o modo principal: informe o XP inicial e compre livremente níveis Novato (`10 XP`), Adepto (`30 XP` acumulados) ou Mestre (`60 XP` acumulados), acompanhando em tempo real quanto foi gasto e quanto ainda resta. Também continuam disponíveis **Cinco Novatas** e **Duas Novatas + uma Adepta**. A lista inclui todas as Habilidades do mundo às quais o jogador possui ao menos permissão de **Observer**; clique em uma para ler sua descrição e os três níveis completos. Traços raciais opcionais entram automaticamente no cálculo, e os documentos selecionados são copiados para a ficha com os níveis corretos.
